...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<!-- Reset Stylesheet -->
		<link rel="stylesheet" href="<?php echo CSS.'simpla_css/'; ?>reset.css" type="text/css" media="screen" />
	  
		<!-- Main Stylesheet -->
		<link rel="stylesheet" href="<?php echo CSS.'simpla_css/'; ?>style.css" type="text/css" media="screen" />
		
		<!-- Invalid Stylesheet. This makes stuff look pretty. Remove it if you want the CSS completely valid -->
		<link rel="stylesheet" href="<?php echo CSS.'simpla_css/'; ?>invalid.css" type="text/css" media="screen" />	
		...
		<!-- jQuery -->
		<script type="text/javascript" src="<?php echo JS.'simpla_scripts/'; ?>jquery-1.3.2.min.js"></script>
		
		<!-- jQuery Configuration -->
		<script type="text/javascript" src="<?php echo JS.'simpla_scripts/'; ?>simpla.jquery.configuration.js"></script>
		
		<!-- Facebox jQuery Plugin -->
		<script type="text/javascript" src="<?php echo JS.'simpla_scripts/'; ?>facebox.js"></script>
		
		<!-- jQuery WYSIWYG Plugin -->
		<script type="text/javascript" src="<?php echo JS.'simpla_scripts/'; ?>jquery.wysiwyg.js"></script>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<!-- Logo (221px wide) -->
			<a href="#"><img id="logo" src="../../webroot/img/simpla_img/logo.png" alt="Simpla Admin logo" /></a>
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class="current" href="#">Liste des Articles</a></li> <!-- Add class "current" to sub menu items also -->
						<li><a href="#">Commentaires</a></li>
						<li><a href="#">Catégories d'Articles</a></li>
					</ul>
				</li>
